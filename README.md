...
| --- | --- |
| Archive model | Structured `.avk` archives using `header.bin`, `keychain.pgn`, and `payload.enc` |
...
| Task | Command |
| --- | --- |
| Create a protected archive | `avikal enc document.pdf -p "StrongPass#123"` |
| Create with keyphrase | `avikal enc document.pdf --keyphrase "word1 word2 ... word21"` |
| Create with PQC keyfile | `avikal enc document.pdf -p "StrongPass#123" --pqc` |
...
- PQC-assisted archives require the external `.avkkey` file during unlock.
